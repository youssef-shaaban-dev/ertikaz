...
export default function CapabilitiesSection() {
  ...
  return (
    <section id="capabilities" className="py-24 bg-white relative z-20 overflow-hidden px-6 lg:px-12">
      {/* Background Accents */}
      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        {/* SECTION 1: OPERATIONAL JOURNEY & COMPANY SERVICES */}
        ...
        <div className="space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-blue-950 leading-tight tracking-tight">
              {isRtl ? "شركاء النجاح في مختلف القطاعات" : "Empowering Varied Market Sectors"}
            </h2>
            <p className="text-slate-500 text-sm sm:text-base font-semibold leading-relaxed">
              {isRtl 
